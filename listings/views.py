...
from listings.search_handlers import get_product_search_handler_class
Listing = get_model('listings', 'Listing')
	
class ListingDetailView(DetailView):
    context_object_name = 'product'
    model = Listing
    template_folder = "listings"
...
class ListingView(TemplateView):
    ...
    template_name = 'oscar/listings/browse.html'
